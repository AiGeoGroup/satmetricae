...
class TripletAELoss(nn.Module):
    ...
    def forward(self, anchor, positive, negative, anchor_img, pred_img, gamma=0.01):
        ...
        losses = torch.relu(distance_positive - distance_negative + self.margin) + gamma * contruct_loss
        return losses.mean()
